...
public interface AdminService {
	...
	OffresValides validateOffre(UUID offreId);

	Optional<OffresValides> getValidatedOffreByAppelOffreId(UUID appelOffreId);

	boolean checkEntrepriseOfferExistence(String entrepriseid, UUID appelOffreId);
}
